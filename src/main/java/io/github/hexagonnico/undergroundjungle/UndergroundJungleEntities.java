...
public class UndergroundJungleEntities {
    ...
    public static void registerAttributes() {
        FabricDefaultAttributeRegistry.register(MOSSY_SKELETON, MossySkeleton.createAbstractSkeletonAttributes());
        FabricDefaultAttributeRegistry.register(JUNGLE_ZOMBIE, JungleZombie.createZombieAttributes());
    }
