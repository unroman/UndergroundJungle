...
public class UndergroundJungleBlocks {
    ...
    public static final Block TEMPLE_BRICKS = register("temple_bricks", new Block(AbstractBlock.Settings.create().requiresTool().mapColor(MapColor.TERRACOTTA_BROWN).sounds(BlockSoundGroup.STONE).strength(30.0f, 1200.0f)));
    ...
    public static final Block JUNGLE_VINES_PLANT = register("jungle_vines_plant", new JungleVinesPlantBlock(AbstractBlock.Settings.create().noCollision().breakInstantly().sounds(BlockSoundGroup.CAVE_VINES)));
